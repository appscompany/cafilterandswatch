(function () {
  ...
  var _collectiongridSelector = '';
  var gridSelectorHTTPRequest = new XMLHttpRequest();
  gridSelectorHTTPRequest.onreadystatechange = function success() {
    /* if (!gridSelectorHTTPRequest.reponseText) {
      return;
    }*/
